...
data5: Test labels
data6£ºEach row identifies the subject who performed the activity for each window sample.
data7£ºEach row identifies the subject who performed the activity for each window sample.

data8£ºThe training and the test sets only on the measurements on the mean and standard deviation with appropriate names. 
